      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <img 
            ...
            className="h-20 w-auto drop-shadow-2xl mx-auto mb-4 hover:drop-shadow-3xl transition-all duration-500 hover:scale-110"
          />
          <h1 className="text-3xl font-bold text-white mb-2">Admin Portal</h1>
          <p className="text-slate-300">Access the Bike Rental dashboard</p>
        </div>
        ...
        <div className="text-center mt-6">
          <p className="text-slate-400 text-sm">
            © 2024 Bike Rental. Admin access only.
          </p>
        </div>
      </div>
    </div>
